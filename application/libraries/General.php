...
class General {
	...
	function loadViews($viewName = "", $headerInfo = NULL, $pageInfo = NULL, $footerInfo = NULL)
	{
		...
		$headerInfo['site_name'] = $sitesetting[5]['SettingValue'];
    	$headerInfo['site_logo'] = $sitesetting[8]['SettingValue'];
		$headerInfo['site_favicon'] = $sitesetting[9]['SettingValue'];
		$headerInfo['pageTitle'] = $sitesetting[5]['SettingValue'] .' '. $headerInfo['pageTitle'];
	...
	function loadViewsFront($viewName = "", $headerInfo = NULL, $pageInfo = NULL, $footerInfo = NULL,$extra = NULL)
	{
		...
		$headerInfo['site_logo'] = $sitesetting[8]['SettingValue'];
		$headerInfo['site_favicon'] = $sitesetting[9]['SettingValue'];
        $headerInfo['pageTitle'] = $sitesetting[7]['SettingValue'] .' '. $headerInfo['pageTitle'];
