									...
									<tbody>
										<tr>
											<td style="width:600px;background-color:#ced0d0">
												...
												<?php $logo = $this->common->get_one_value('tblsetting',array('SettingKey'=>'FrontEnd_Logo_2'),'SettingValue'); ?> 
									...
									<tbody>
										<tr>
											<td style="width:550px;background-color:#ffffff;border-top:1px solid #bbbaba;border-right:1px solid #bbbaba;border-left:1px solid #bbbaba;border-radius:5px 5px 0px 0px;">
												<h3 style="color: #999999;margin-top:20px;padding-left: 10px"> Hello <?= ucwords($user_data['fname']." ".$user_data['lname']) ?> , </h3> 
											</td>
										</tr>
										<tr>
											<td style="width:478px;padding:10px;font-size:14px;font-family:Montserrat,arial,sans-serif;line-height:20px;text-align:center;vertical-align:top;background-color:#ffffff;color:#999999" align="center"> <a href="<?php echo base_url('reset-password/'.$ForgotString); ?>">Click Here to Reset Passowrd </a></td>
										</tr>
