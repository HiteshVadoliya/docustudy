									...
									<tbody>
										...
										<tr>
											<td style="width:548px;border-bottom:1px solid #bbbaba;border-left:1px solid #bbbaba;border-right:1px solid #bbbaba;border-radius:0px 0px 5px 5px;background-color:#ffffff" align="center">
												...
												<tbody>
													<tr>
														<td style="width:478px;padding:10px;font-size:14px;font-family:Montserrat,arial,sans-serif;line-height:20px;text-align:center;vertical-align:top;background-color:#ffffff;color:#999999" align="center"> Please confirm Your Email : <a href="<?php echo base_url('confirm-account/'.$ForgotString); ?>">Click Here to Confirm Account </a>
													</tr>
                                                    <tr>
