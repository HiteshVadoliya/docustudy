...
<section class="content-header">
   <h1 class="pull-left col-md-3"><i class="fa fa-university"></i>&nbsp;Manage Faq</h1>
   ...
   <div class="box">
      <div class="box-header with-border">
         ...
         <div class="pull-right">
            <a href="<?= base_url(ADMIN.'add-faq') ?>" class="btn btn-info btn-flat"> <i class="fa fa-plus"> </i> Add Faq</a>
         </div>
      </div>
      <div class="box-body">
         <div class="row">
...
function gettour(page_num) {
   ...
   $.ajax({
      type: 'POST',
      url: '<?php echo base_url(ADMIN); ?>Faq/ajax_faq/'+page_num,
