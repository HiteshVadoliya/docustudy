<header class="main-header">
    ...
    <a href="<?= base_url(ADMIN) ?>" class="logo">
      ...
      <span class="logo-mini">DS<!-- <img src="<?= base_url(LOGOPATH.'admin-logo-mini.png') ?>" alt=""> --><!-- <b>T</b>A --></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">
      <img src="<?= LOGOPATH.getSiteSetting('Admin_Logo_2'); ?>" alt="" style="max-width: 80px; max-height: 40px;">
      </span>
    </a>
