...
<section class="content-header">
   ...
   if(!empty($edit)) {
   ?>
   <h1><i class="fa fa-plus"></i>&nbsp;Edit How it Works</h1>
   <?php
   }
   else {
   ?>
   <h1><i class="fa fa-plus"></i>&nbsp;Add How it Works</h1>
   <?php
   }
   ?>
</section>
...
<section class="content">
   ...
   <div class="box box-info">
      ...
      if(!empty($edit)) {
      ?>
      <form role="form" action="<?= ADMIN_LINK.'Content/create_update_howitworks/'.$edit['id'] ?>" method="post" id="frm" enctype="multipart/form-data">
      <?php
      }
      else {
      ?>
      <form role="form" action="<?= ADMIN_LINK.'Content/create_update_howitworks' ?>" method="post" id="frm" enctype="multipart/form-data">
      <?php
      }
      ?>
