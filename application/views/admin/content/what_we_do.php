...
<section class="content-header">
   ...
   if(!empty($edit)) {
   ?>
   <h1><i class="fa fa-plus"></i>&nbsp;Edit What we do</h1>
   <?php
   }
   else {
   ?>
   <h1><i class="fa fa-plus"></i>&nbsp;Add What we do</h1>
   <?php
   }
   ?>
</section>
...
<section class="content">
   ...
   <div class="box box-info">
      ...
      if(!empty($edit)) {
      ?>
      <form role="form" action="<?= ADMIN_LINK.'Content/create_update_what_we_do/'.$edit['id'] ?>" method="post" id="bulletinForm" enctype="multipart/form-data">
      <?php
      }
      else {
      ?>
      <form role="form" action="<?= ADMIN_LINK.'Content/create_update_what_we_do' ?>" method="post" id="bulletinForm" enctype="multipart/form-data">
      <?php
      }
      ?>
