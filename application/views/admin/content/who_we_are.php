...
<section class="content-header">
   ...
   if(!empty($edit)) {
   ?>
   <h1><i class="fa fa-plus"></i>&nbsp;Edit who we are</h1>
   <?php
   }
   else {
   ?>
   <h1><i class="fa fa-plus"></i>&nbsp;Add who we are</h1>
   <?php
   }
   ?>
</section>
...
<section class="content">
   ...
   <div class="box box-info">
      ...
      if(!empty($edit)) {
      ?>
      <form role="form" action="<?= ADMIN_LINK.'Content/create_update_who_we_are/'.$edit['id'] ?>" method="post" id="bulletinForm" enctype="multipart/form-data">
      <?php
      }
      else {
      ?>
      <form role="form" action="<?= ADMIN_LINK.'Content/create_update_who_we_are' ?>" method="post" id="bulletinForm" enctype="multipart/form-data">
      <?php
      }
      ?>
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="form-group">
                     ...
                     <input type="text" name="title" id="title" class="form-control" value="<?php if(isset($edit)) { echo $edit['title']; } ?>">
                  </div>
               </div>
               ...
               <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="text" name="footer_heading" id="footer_heading" class="form-control" value="<?php if(isset($edit)) { echo $edit['footer_heading']; } ?>">
                     </div>
               </div>
         ...
         <div class="box-footer">
            <button type="submit" class="btn btn-primary"><?php if(!empty($edit)) { echo 'Modify'; }else { echo 'save'; } ?></button>
