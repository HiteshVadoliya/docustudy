...
<section class="content-header">
   ...
   if(isset($demo)) {
   ?>
   <h1><i class="fa fa-pencil"></i>&nbsp;Edit Demo</h1>
   <?php
   }
   else {
   ?>
   <h1><i class="fa fa-plus"></i>&nbsp;Add Demo</h1>
   <?php
   }
   ?>
</section>
   ...
   <div class="box box-info">      
     ...
     <div class="tab-content">
       <div>
            ...
            if(isset($demo)) {
            ?>
            <form role="form" action="<?= ADMIN_LINK.'Demo/save_data/'.$demo['id'] ?>" method="post" id="frm" enctype="multipart/form-data">
            <?php
            }
            else {
            ?>
            <form role="form" action="<?= ADMIN_LINK.'Demo/save_data' ?>" method="post" id="frm" enctype="multipart/form-data">
            <?php
            }
            ?>
               <div class="box-body">
