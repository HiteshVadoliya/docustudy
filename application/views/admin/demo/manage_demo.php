...
<section class="content-header">
   <h1 class="pull-left col-md-3"><i class="fa fa-university"></i>&nbsp;Manage Demo</h1>
...
<section class="content">
   ...
   <div class="box">
      <div class="box-header with-border">
         <h3 class="box-title">Manage Demo</h3>
         <div class="pull-right">
            <a href="<?= base_url(ADMIN.'add-demo') ?>" class="btn btn-info btn-flat"> <i class="fa fa-plus"> </i> Add Demo</a>
         </div>
      </div>
      <div class="box-body">
         <div class="row">
...
function gettour(page_num) {
   ...
   $.ajax({
      type: 'POST',
      url: '<?php echo base_url(ADMIN); ?>Demo/ajax_demo/'+page_num,
